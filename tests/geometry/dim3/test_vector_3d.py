...
class Vector3DTest(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.params_length = [
            ...
            (Vector3D(0.0, 0.0, -14.0), 14.0), (Vector3D(8.0, 6.0, 0.0), 10.0),
            (Vector3D(8.0, -6.0, 0.0), 10.0), (Vector3D(-8.0, 6.0, 0.0), 10.0),
            (Vector3D(-8.0, -6.0, 0.0), 10.0), (Vector3D(8.0, 0.0, 6.0), 10.0),
            (Vector3D(8.0, 0.0, -6.0), 10.0), (Vector3D(-8.0, 0.0, 6.0), 10.0),
            (Vector3D(-8.0, 0.0, -6.0), 10.0), (Vector3D(0.0, 8.0, 6.0), 10.0),
            (Vector3D(0.0, 8.0, -6.0), 10.0), (Vector3D(0.0, -8.0, 6.0), 10.0),
            (Vector3D(0.0, -8.0, -6.0), 10.0), (Vector3D(18.0, 6.0, 13.0), 23.0),
            (Vector3D(18.0, 6.0, -13.0), 23.0), (Vector3D(18.0, -6.0, 13.0), 23.0),
            (Vector3D(18.0, -6.0, -13.0), 23.0), (Vector3D(-18.0, 6.0, 13.0), 23.0),
            (Vector3D(-18.0, 6.0, -13.0), 23.0), (Vector3D(-18.0, -6.0, 13.0), 23.0),
            (Vector3D(-18.0, -6.0, -13.0), 23.0)
        ]

    @staticmethod
    def test__coordinates__then_tuple():
        # when
        result = Vector3D(150.123456789, -3700.987654321, 0.55555555).coordinates
    ...
    def test__op_str__then_string_representation():
        # when
        result = str(Vector3D(150.123456789, -3700.987654321, 0.55555555))
