...
class DisjointSetsTest(unittest.TestCase):
    ...
    def test__iadd__when_present_element__then_ValueError(self):
        # when - then
    ...
    def test__getitem__when_absent_element__then_KeyError(self):
        # when - then
    ...
    def test__union_set__when_absent_element__then_KeyError(self):
        # when - then
        with self.assertRaises(KeyError):
    ...
    def test__is_same_set__when_absent__then_KeyError(self):
        # then
        with self.assertRaises(KeyError):
            # when
