...
class DoubleHeapTest(unittest.TestCase):
    ...
    def test_front__when_empty_then_key_error(self):
        # given
        self._test_object = DoubleHeap()
        # then
    ...
    def test_front__when_not_empty_then_minimal_element(self):
        # when
        result = self._test_object.front
        # then
        self.assertEqual(min(self._numbers), result)

    def test_back__when_empty_then_key_error(self):
        # given
        self._test_object = DoubleHeap()
        # then
        with self.assertRaises(KeyError):
    ...
    def test_back__when_single_element_then_this_element(self):
        # given
        element = 19
    ...
    def test_back__when_multiple_elements_then_maximal_element(self):
        # when
        result = self._test_object.back
        # then
        self.assertEqual(max(self._numbers), result)

    def test_push_when_empty_then_added(self):
        # given
        element = 19
        self._test_object = DoubleHeap()
        # when
    ...
    def test_push_when_new_element_is_less_then_added_to_front(self):
        # given
    ...
    def test_push_when_new_element_is_greater_then_added_to_back(self):
        # given
    ...
    def test_push_when_new_element_then_added(self):
        # given
        element = 46
        # when
        self._test_object.push(element)
    ...
    def test_pop_front__when_not_empty_then_minimal_element_removed(self):
        # when
    ...
    def test_pop_front__when_single_element_then_this_element_removed(self):
        # given
        element = 19
        self._test_object = DoubleHeap([element])
        # when
    ...
    def test_pop_back__when_empty_then_key_error(self):
        # given
        self._test_object = DoubleHeap()
        # then
        with self.assertRaises(KeyError):
    ...
    def test_pop_back__when_single_element_then_this_element_removed(self):
        # given
        element = 19
        self._test_object = DoubleHeap([element])
        # when
    ...
    def test_pop_back__when_multiple_elements_then_maximal_element_removed(self):
        # when
        result = self._test_object.pop_back()
        # then
        self.assertEqual(len(self._numbers) - 1, len(self._test_object))
