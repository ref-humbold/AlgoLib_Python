...
class DirectedGraphTest(unittest.TestCase):
    ...
    def test_edges_number(self):
        ...
        self.assertEqual(7, self.__test_object.edges_number)
    ...
    def test_get_indegree(self):
        ...
        self.assertEqual(5, self.__test_object.get_indegree(1))
    ...
    def test_get_outdegree(self):
        ...
        self.assertEqual(5, self.__test_object.get_outdegree(1))
