...
class LCATest(unittest.TestCase):
    ...
    def test__find__when_vertices_in_different_subtrees__then_lca(self):
        # when
        result = self.test_object.find(self.test_object.tree.get_vertex(5),
    ...
    def test__find__when_vertices_swapped__then_same_lca(self):
        # when
        result1 = self.test_object.find(self.test_object.tree.get_vertex(5),
                                        self.test_object.tree.get_vertex(7))
        result2 = self.test_object.find(self.test_object.tree.get_vertex(7),
    ...
    def test__find__when_root_is_common_ancestor__then_root(self):
        # when
        result = self.test_object.find(self.test_object.tree.get_vertex(3),
    ...
    def test__find__when_root_is_one_of_vertices__then_root(self):
        # when
        result = self.test_object.find(self.test_object.tree.get_vertex(4), self.test_object.root)
        # then
        assert_that(result).is_equal_to(self.test_object.root)
