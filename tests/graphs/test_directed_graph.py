...
class DirectedSimpleGraphTest(unittest.TestCase):
    ...
    def test__get_edge__when_reversed_direction__then_key_error(self):
        ...
        with self.assertRaises(KeyError):
            # when
            self.test_object.get_edge(destination, source)
    ...
    def test__add_edge_between__when_new_edge__then_created_edge(self):
        ...
        self.assertListEqual([], list(self.test_object.neighbours(5)))
    ...
    def test__reverse__then_all_edges_have_reversed_direction(self):
        ...
        edge_property = "zxcvb"
        edge = self.test_object.add_edge_between(1, 2)
        self.test_object.add_edge_between(3, 5)
        self.test_object.add_edge_between(4, 9)
        self.test_object.add_edge_between(5, 4)
        self.test_object.add_edge_between(5, 7)
        self.test_object.add_edge_between(6, 2)
        self.test_object.add_edge_between(6, 6)
        self.test_object.add_edge_between(7, 8)
        self.test_object.add_edge_between(9, 1)
        self.test_object.add_edge_between(9, 6)
        self.test_object[vertex] = vertex_property
        self.test_object[edge] = edge_property
        # when
        ...
        self.assertIsNone(self.test_object[self.test_object.get_edge(5, 3)])
