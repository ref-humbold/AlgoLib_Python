...
class EquationSystem:
    ...
    def __change(self, equ1, equ2):
        ...
        for i in range(self.__equations):
            self.__coeffs[equ1][i], self.__coeffs[equ2][i] = self.__coeffs[equ2][i], self.__coeffs[equ1][i]

        self.__free_terms[equ1], self.__free_terms[equ2] = self.__free_terms[equ2], self.__free_terms[equ1]
