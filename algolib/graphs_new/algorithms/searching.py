...
def bfs(graph: Graph, strategy: BFSStrategy, roots: Iterable[Vertex]) -> List[Vertex]:
...
def dfs_iterative(graph: Graph, strategy: DFSStrategy, roots: Iterable[Vertex]) -> List[Vertex]:
...
def dfs_recursive(graph: Graph, strategy: DFSStrategy, roots: Iterable[Vertex]) -> List[Vertex]:
    ...
    return list(state.reached.keys())
